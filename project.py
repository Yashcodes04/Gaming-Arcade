...
snake_img = PhotoImage(file=r"C:\Users\Yash\OneDrive\Desktop\projectimg.png")
canvas.create_image(440,300,image=snake_img)
canvas.pack()

button_1 = Button(text="START GAME") #pac
button_1.place(x=400,y=500)
button_2=Button(text="START GAME",command=s) #snake
button_2.place(x=120,y=500)
button_3=Button(text="START GAME",command=d) #dots
button_3.place(x=650,y=500)
window.mainloop()
